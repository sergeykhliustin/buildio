...
public struct V0BuildListAllResponseItemModel: Codable, Identifiable, Hashable {
    ...
    public init(abortReason: String? = nil, branch: String? = nil, buildNumber: Int? = nil, commitHash: String? = nil, commitMessage: String? = nil, commitViewUrl: String? = nil, creditCost: Int? = nil, environmentPrepareFinishedAt: String? = nil, finishedAt: String? = nil, isOnHold: Bool? = nil, isProcessed: Bool? = nil, machineTypeId: String? = nil, originalBuildParams: String? = nil, pullRequestId: Int? = nil, pullRequestTargetBranch: String? = nil, pullRequestViewUrl: String? = nil, repository: V0AppResponseItemModel? = nil, slug: String = "", stackIdentifier: String? = nil, startedOnWorkerAt: String? = nil, status: Status? = nil, statusText: String = "", tag: String? = nil, triggeredAt: String? = nil, triggeredBy: String? = nil, triggeredWorkflow: String? = nil) {
