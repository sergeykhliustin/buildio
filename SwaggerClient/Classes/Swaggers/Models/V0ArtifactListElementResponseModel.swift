...
public struct V0ArtifactListElementResponseModel: Codable {
    ...
    public init(artifactMeta: [Int]? = nil, artifactType: NullsString? = nil, fileSizeBytes: Int? = nil, isPublicPageEnabled: Bool? = nil, slug: String? = nil, title: NullsString? = nil) {
