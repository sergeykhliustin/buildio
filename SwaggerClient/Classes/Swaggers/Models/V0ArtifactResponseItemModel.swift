...
public struct V0ArtifactResponseItemModel: Codable {
    ...
    public var artifactType: NullsString?
    ...
    public init(artifactMeta: [Int]? = nil, artifactType: NullsString? = nil, expiringDownloadUrl: String? = nil, fileSizeBytes: Int? = nil, isPublicPageEnabled: Bool? = nil, publicInstallPageUrl: String? = nil, slug: String? = nil, title: NullsString? = nil) {
