...
final class ViewModelFactory {
    ...
    func builds(app: V0AppResponseItemModel?) -> BuildsViewModel {
    ...
    func logs(_ build: BuildResponseItemModel) -> LogsViewModel {
        LogsViewModel(tokenManager, build: build)
    }
    
    func artifacts(_ build: BuildResponseItemModel) -> ArtifactsViewModel {
    ...
    func branches(app: V0AppResponseItemModel) -> BranchesViewModel {
        BranchesViewModel(tokenManager, app: app)
    }
    
    func workflows(app: V0AppResponseItemModel) -> WorkflowsViewModel {
