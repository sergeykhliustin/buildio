...
package final class AppleApiCredentialsAPI: BaseAPI {
    ...
    package func appleApiCredentialList(userSlug: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue) async throws -> V0AppleAPICredentialsListResponse {
