...
package final class TestDevicesAPI: BaseAPI {
    ...
    package func testDeviceList(appSlug: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue) async throws -> V0TestDeviceListResponseModel {
