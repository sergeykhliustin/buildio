...
class URLSessionRequestBuilder<T>: RequestBuilder<T>, @unchecked Sendable {
    ...
    @discardableResult
    override func executeCompletion(_ completion: @Sendable @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        ...
        do {
            ...
            let dataTask = urlSession.dataTask(with: request) { data, response, error in
                ...
                let wrappedCompletion: (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void = { result in
                    completion(result)
                    logger.debug("Request: \(T.self), \(requestUrl)")
...
class URLSessionDecodableRequestBuilder<T: Codable>: URLSessionRequestBuilder<T> {
