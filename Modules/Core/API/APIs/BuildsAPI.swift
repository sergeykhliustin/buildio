...
package final class BuildsAPI: BaseAPI {
    ...
    package func buildAbort(appSlug: String, buildSlug: String, buildAbortParams: V0BuildAbortParams) async throws -> V0BuildAbortResponseModel {
        return try await buildAbortWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, buildAbortParams: buildAbortParams).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildBitriseYmlShow(appSlug: String, buildSlug: String) async throws -> String {
        return try await buildBitriseYmlShowWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug).execute().body
    }
     ...
     */
    package enum SortBy_buildList: String, CaseIterable {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildList(appSlug: String, sortBy: SortBy_buildList? = nil, branch: String? = nil, workflow: String? = nil, commitMessage: String? = nil, triggerEventType: String? = nil, pullRequestId: Int? = nil, buildNumber: Int? = nil, after: Date? = nil, before: Date? = nil, status: BuildResponseItemModel.Status? = nil, next: String? = nil, limit: Int? = nil) async throws -> V0BuildListResponseModel {
        return try await buildListWithRequestBuilder(appSlug: appSlug, sortBy: sortBy, branch: branch, workflow: workflow, commitMessage: commitMessage, triggerEventType: triggerEventType, pullRequestId: pullRequestId, buildNumber: buildNumber, after: after, before: before, status: status, next: next, limit: limit).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildListAll(ownerSlug: String? = nil, isOnHold: Bool? = nil, status: Int? = nil, next: String? = nil, limit: Int? = nil) async throws -> V0BuildListResponseModel {
        return try await buildListAllWithRequestBuilder(ownerSlug: ownerSlug, isOnHold: isOnHold, status: status, next: next, limit: limit).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildLog(appSlug: String, buildSlug: String, timestamp: String? = nil) async throws -> BuildLogResponseModel {
        return try await buildLogWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, timestamp: timestamp).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildShow(appSlug: String, buildSlug: String) async throws -> V0BuildShowResponseModel {
        return try await buildShowWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildTrigger(appSlug: String, buildParams: BuildTriggerParams) async throws -> V0BuildTriggerRespModel {
        return try await buildTriggerWithRequestBuilder(appSlug: appSlug, buildParams: buildParams).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildWorkflowList(appSlug: String) async throws -> V0BuildWorkflowListResponseModel {
        return try await buildWorkflowListWithRequestBuilder(appSlug: appSlug).execute().body
    }
