...
package final class BuildCertificateAPI: BaseAPI {
    ...
    package func buildCertificateConfirm(appSlug: String, buildCertificateSlug: String) async throws -> V0BuildCertificateResponseModel {
        return try await buildCertificateConfirmWithRequestBuilder(appSlug: appSlug, buildCertificateSlug: buildCertificateSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildCertificateCreate(appSlug: String, buildCertificate: V0BuildCertificateUploadParams) async throws -> V0BuildCertificateResponseModel {
        return try await buildCertificateCreateWithRequestBuilder(appSlug: appSlug, buildCertificate: buildCertificate).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildCertificateDelete(appSlug: String, buildCertificateSlug: String) async throws -> V0BuildCertificateResponseModel {
        return try await buildCertificateDeleteWithRequestBuilder(appSlug: appSlug, buildCertificateSlug: buildCertificateSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildCertificateList(appSlug: String, next: String? = nil, limit: Int? = nil) async throws -> V0BuildCertificateListResponseModel {
        return try await buildCertificateListWithRequestBuilder(appSlug: appSlug, next: next, limit: limit).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildCertificateShow(appSlug: String, buildCertificateSlug: String) async throws -> V0BuildCertificateResponseModel {
        return try await buildCertificateShowWithRequestBuilder(appSlug: appSlug, buildCertificateSlug: buildCertificateSlug).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<V0BuildCertificateResponseModel> 
     */
    func buildCertificateShowWithRequestBuilder(appSlug: String, buildCertificateSlug: String) -> RequestBuilder<V0BuildCertificateResponseModel> {
        var localVariablePath = "/apps/{app-slug}/build-certificates/{build-certificate-slug}"
        let appSlugPreEscape = "\(APIHelper.mapValueToPathItem(appSlug))"
        let appSlugPostEscape = appSlugPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{app-slug}", with: appSlugPostEscape, options: .literal, range: nil)
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func buildCertificateUpdate(appSlug: String, buildCertificateSlug: String, buildCertificate: V0BuildCertificateUpdateParams) async throws -> V0BuildCertificateResponseModel {
        return try await buildCertificateUpdateWithRequestBuilder(appSlug: appSlug, buildCertificateSlug: buildCertificateSlug, buildCertificate: buildCertificate).execute().body
    }
