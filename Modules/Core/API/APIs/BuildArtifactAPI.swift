...
package final class BuildArtifactAPI: BaseAPI {
    ...
    package func artifactDelete(appSlug: String, buildSlug: String, artifactSlug: String) async throws -> V0ArtifactDeleteResponseModel {
        return try await artifactDeleteWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug).execute().body
    }
    ...
    private func artifactDeleteWithRequestBuilder(appSlug: String, buildSlug: String, artifactSlug: String) -> RequestBuilder<V0ArtifactDeleteResponseModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<V0ArtifactDeleteResponseModel>.Type = requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func artifactList(appSlug: String, buildSlug: String, next: String? = nil, limit: Int? = nil) async throws -> V0ArtifactListResponseModel {
        return try await artifactListWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, next: next, limit: limit).execute().body
    }
    ...
    private func artifactListWithRequestBuilder(appSlug: String, buildSlug: String, next: String? = nil, limit: Int? = nil) -> RequestBuilder<V0ArtifactListResponseModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<V0ArtifactListResponseModel>.Type = requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func artifactShow(appSlug: String, buildSlug: String, artifactSlug: String, download: Int? = nil) async throws -> V0ArtifactShowResponseModel {
        return try await artifactShowWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug, download: download).execute().body
    }

    /**
     Get a specific build artifact
     - GET /apps/{app-slug}/builds/{build-slug}/artifacts/{artifact-slug}
     - Retrieve data of a specific build artifact. The response output contains a time-limited download url (expires in 10 minutes) and a package install page URL. You can view the build artifact with both URLs, but the package install page url will not work unless you [enable it](https://devcenter.bitrise.io/tutorials/deploy/bitrise-app-deployment/#enabling-public-page-for-the-app).
     - API Key:
       - type: apiKey Bitrise-Addon-Auth-Token 
       - name: AddonAuthToken
     - API Key:
    ...
    private func artifactShowWithRequestBuilder(appSlug: String, buildSlug: String, artifactSlug: String, download: Int? = nil) -> RequestBuilder<V0ArtifactShowResponseModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<V0ArtifactShowResponseModel>.Type = requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func artifactUpdate(appSlug: String, buildSlug: String, artifactSlug: String, artifactParams: V0ArtifactUpdateParams) async throws -> V0ArtifactShowResponseModel {
        return try await artifactUpdateWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug, artifactParams: artifactParams).execute().body
    }
