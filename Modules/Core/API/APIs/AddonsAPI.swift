...
package final class AddonsAPI: BaseAPI {
    ...
    package func addonListByApp(appSlug: String) async throws -> V0AppAddOnsListResponseModel {
        return try await addonListByAppWithRequestBuilder(appSlug: appSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func addonListByOrganization(organizationSlug: String) async throws -> V0OwnerAddOnsListResponseModel {
        return try await addonListByOrganizationWithRequestBuilder(organizationSlug: organizationSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func addonListByUser(userSlug: String) async throws -> V0OwnerAddOnsListResponseModel {
        return try await addonListByUserWithRequestBuilder(userSlug: userSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func addonsList() async throws -> V0AddonsListResponseModel {
        return try await addonsListWithRequestBuilder().execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func addonsShow(addonId: String) async throws -> V0AddonsShowResponseModel {
        return try await addonsShowWithRequestBuilder(addonId: addonId).execute().body
    }
