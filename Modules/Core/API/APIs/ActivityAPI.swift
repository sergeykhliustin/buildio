...
package final class ActivityAPI: BaseAPI, @unchecked Sendable {
    ...
    package func activityList(next: String? = nil, limit: Int? = nil) async throws -> V0ActivityEventListResponseModel {
        return try await activityListWithRequestBuilder(next: next, limit: limit).execute().body
    }
