...
package final class AppleApiCredentialsAPI: BaseAPI {
    ...
    package func appleApiCredentialList(userSlug: String) async throws -> V0AppleAPICredentialsListResponse {
        return try await appleApiCredentialListWithRequestBuilder(userSlug: userSlug).execute().body
    }
