...
package final class GenericProjectFileAPI: BaseAPI {
    ...
    package func genericProjectFileConfirm(appSlug: String, genericProjectFileSlug: String) async throws -> V0ProjectFileStorageResponseModel {
        return try await genericProjectFileConfirmWithRequestBuilder(appSlug: appSlug, genericProjectFileSlug: genericProjectFileSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func genericProjectFileDelete(appSlug: String, genericProjectFileSlug: String) async throws -> V0ProjectFileStorageResponseModel {
        return try await genericProjectFileDeleteWithRequestBuilder(appSlug: appSlug, genericProjectFileSlug: genericProjectFileSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func genericProjectFileList(appSlug: String, next: String? = nil, limit: Int? = nil) async throws -> V0ProjectFileStorageListResponseModel {
        return try await genericProjectFileListWithRequestBuilder(appSlug: appSlug, next: next, limit: limit).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func genericProjectFileShow(appSlug: String, genericProjectFileSlug: String) async throws -> V0ProjectFileStorageResponseModel {
        return try await genericProjectFileShowWithRequestBuilder(appSlug: appSlug, genericProjectFileSlug: genericProjectFileSlug).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func genericProjectFileUpdate(appSlug: String, genericProjectFileSlug: String, genericProjectFile: V0ProjectFileStorageDocumentUpdateParams) async throws -> V0ProjectFileStorageResponseModel {
        return try await genericProjectFileUpdateWithRequestBuilder(appSlug: appSlug, genericProjectFileSlug: genericProjectFileSlug, genericProjectFile: genericProjectFile).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func genericProjectFilesCreate(appSlug: String, genericProjectFile: V0ProjectFileStorageUploadParams) async throws -> V0ProjectFileStorageResponseModel {
        return try await genericProjectFilesCreateWithRequestBuilder(appSlug: appSlug, genericProjectFile: genericProjectFile).execute().body
    }
