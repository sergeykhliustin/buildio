...
package final class OrganizationsAPI: BaseAPI {
    ...
    package func orgList() async throws -> V0OrganizationListRespModel {
        return try await orgListWithRequestBuilder().execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    package func orgShow(orgSlug: String) async throws -> V0OrganizationRespModel {
        return try await orgShowWithRequestBuilder(orgSlug: orgSlug).execute().body
    }
