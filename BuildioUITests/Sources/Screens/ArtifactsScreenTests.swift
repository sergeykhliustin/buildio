...
final class ArtifactsScreenTests: XCTestCase {
    func testSnapshotLight() throws {
        ...
        elementsQuery.buttons["Apps & Artifacts"].waitHittable(self).forceTap()
        app.navigationBars["Build #113 artifacts"].buttons["Build #113"].waitHittable(self)
